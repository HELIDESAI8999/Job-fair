...
<body >
    ...
    <div class="body" style="transform: translate(0%, 10%);">
        <!-- Host an Event Button -->
    <div class="container" >
        <div class="row justify-content-around">
            <button type="button" class="btn btn-primary btn-lg " onclick="send()" >Host an event</button>
        </div>
    </div>
    <script>
    function send()
    {
        window.location.replace("orgform.php");
    }
    </script>
 <div class="container " style="padding-top:100px;">
    <div class="row justify-content-around">
    <div class="list-group col">
        <button type="button" class="list-group-item  btn-color">All Events </button>
    ...
    <div class="list-group col">
        <button type="button" class="list-group-item btn-color">Your Events</button>
       ...
       <?php
        ...
        $a = $_SESSION['user'];
            $query = "SELECT * FROM events where owner like '$a'"; //enter table name here
            $result = mysqli_query($con, $query);
        ...
        <ul class="list-group list-group-flush">
            <li class="list-group-item">
                <div class="card" >
                    <img src="<?php echo $row['date']; ?> " class="card-img-top" onerror="this.src='picture/default-img.gif'" style="height: 10rem;" />
                    <div class="card-body">
                      <h5 class="card-title"><?php echo $row['owner']; ?></h5> <!-- insert event-title column name -->
                      <label>ORGANISATION: </label>
                      <?php echo $row['org_name']; ?></h5> <!-- insert event-title column name -->
                      <p class="card-text">
                        <ul class="list-group list-group-flush">
